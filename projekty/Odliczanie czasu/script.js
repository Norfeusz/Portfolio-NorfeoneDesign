...
const minutesitle = document.querySelector('#minutes-title')
...
const calculateTimeDifference = () => {
    ...
    if (differenceInDays ==1){
        daysTitle.innerText ="Dzień"
    } else {
        daysTitle.innerText ="Dni"
    }
    if (differenceInHours == 23 || differenceInHours == 24){
        hoursTitle.innerText = "Godziny"
    } else {
        hoursTitle.innerText = "Godzin"
    }
    if(differenceInMinutes ==1 ){
        minutesTitle.innerText = "minuta"
    }else if(differenceInMinutes ==2||3||4){
        minutesTitle.innerText = "minuty"
    }
}else{
