...
const converterWebsiteOpen = () => {
	...
	if (actualLanguage === 'pl') {
		window.open('./projekty/Konwerter temperatury/pl/index.html', '_blank')
	} else {
...
const converterHtmlOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Konwerter temperatury/pl/index.txt', '_blank')
	} else {
...
const weatherWebsiteOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/WeatherApp_pliki_startowe/pl/index.html', '_blank')
	} else {
...
const weatherHtmlOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/WeatherApp_pliki_startowe/pl/index.txt', '_blank')
	} else {
...
const financesWebsiteOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Menadżer finansów/pl/index.html', '_blank')
	} else {
...
const financesHtmlOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Menadżer finansów/pl/index.txt', '_blank')
	} else {
...
const financesJsOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Menadżer finansów/script.js', '_blank')
	} else {
...
const timerWebsiteOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Stoper/pl/index.html', '_blank')
	} else {
...
const timerHtmlOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Stoper/pl/index.txt', '_blank')
	} else {
...
const timerJsOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Stoper/script.js', '_blank')
	} else {
...
const drinksWebsiteOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Wyszukiwarka napojów/pl/index.html', '_blank')
	} else {
...
const drinksHtmlOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Wyszukiwarka napojów/pl/index.txt', '_blank')
	} else {
...
const notepadWebsiteOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Notatnik/pl/index.html', '_blank')
	} else {
...
const notepadHtmlOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Notatnik/pl/index.txt', '_blank')
	} else {
...
const notepadJsOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Notatnik/script.js', '_blank')
	} else {
...
const countdownWebsiteOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Odliczanie czasu/pl/index.html', '_blank')
	} else {
...
const countdownHtmlOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Odliczanie czasu/pl/index.txt', '_blank')
	} else {
...
const countdownJsOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Odliczanie czasu/script.js', '_blank')
	} else {
...
const calculatorWebsiteOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Kalkulator napiwków/pl/index.html', '_blank')
	} else {
...
const calculatorHtmlOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Kalkulator napiwków/pl/index.txt', '_blank')
	} else {
...
const calculatorJsOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Kalkulator napiwków/script.js', '_blank')
	} else {
...
const walidatorWebsiteOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Walidator hasła/pl/index.html', '_blank')
	} else {
...
const walidatorHtmlOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Walidator hasła/pl/index.txt', '_blank')
	} else {
...
const walidatorJsOpen = () => {
	const actualLanguage = localStorage.getItem('language')
	if (actualLanguage === 'pl') {
		window.open('./projekty/Walidator hasła/script.js', '_blank')
	} else {
